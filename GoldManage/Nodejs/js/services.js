angular.module('goalapp.services', [])
  .factory('goalaccAPIservice', function() {
	...
	var unit = [
			{ id: 1, code: 'dvt01', name: 'chiếc', isuse: true, isdelete: false},
	...
	var invoicedetail = [
			...
			{ id: 2, no: 'i002', name: 'vàng miếng', weightO: 2.0, weight: 2.0, itemtype: 1, itemname: 'c', ininvoiceid: 1, price: 200, amount: 400},
